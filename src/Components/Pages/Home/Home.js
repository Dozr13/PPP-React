    ...
    <main id='home-container'>
      <section id='intro'>
        ...
        <div className='img-container'>
          <img className='intro-img' src={process.env.PUBLIC_URL + '/img/self.jpg'} alt='Wade Pate' />
        </div>
      </section>
      <section id='intro-container'>
        ...
        <br/>
        <br/>
          I'm fluent in Web Development Technologies, specifically React, JavaScript, CSS, Node.js, PostgreSQL, Redux, and Context.
